...
import background from "../assets/modern-background-designed-for-a-music-streaming-w.png";
            ...
            <div className="w-full sm:w-1/2 flex justify-center items-center px-6 py-12 sm:px-8">
                <div className="sm:w-full sm:max-w-sm">
                    ...
                    <div className="flex flex-col items-center space-y-4 mb-8">
                        <img src={logo} alt="Logo" className="h-16 w-16" /> {/* Adjust size */}
                        <span className="text-3xl font-semibold text-gray-900">DOT-Music</span>
                    </div>
